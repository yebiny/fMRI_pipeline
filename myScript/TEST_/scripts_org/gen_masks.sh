...
outputDir=inter_output/gen_masks
mkdir -p $outputDir

inputfile=$SECONDLEVEL_DIR/phase1_stimBase.gfeat/cope3.feat/stats/zstat1.nii.gz
...
anatMask=/Users/ghootaekim/fMRI_analysis/primeRecon/visualCortexMasks/mask1_bin.nii.gz
...
inputfile=$SECONDLEVEL_DIR/phase2_repSupp.gfeat/cope3.feat/stats/zstat1.nii.gz
...
inputfile=$SECONDLEVEL_DIR/phase2_repSupp.gfeat/cope4.feat/stats/zstat1.nii.gz
outputfile=$outputDir/temp.nii.gz
fslmaths $inputfile -mas $visCortexMask $outputfile
inputfile=$outputDir/temp.nii.gz
...
anatMask=/Users/ghootaekim/fMRI_analysis/primeRecon/visualCortexMasks/mask2_bin.nii.gz
